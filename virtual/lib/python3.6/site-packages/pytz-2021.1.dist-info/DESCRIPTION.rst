...
service provides translations. Thomas Khyn's
`l18n <https://pypi.org/service/l18n/>`_ package can be used to access
...
Index <https://pypi.org/service/pytz/>`_.  The code that is used
